...
@section('content')
    <div class="container">
        <form id="add-sal" action="{{route("sales.store")}}" method="post">
            @csrf
                ...
                <div class="col-md-12 card p-3">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                      @foreach($categories as $category)
                        <li class="nav-item">
                            <a href="#{{$category->slug}}" class="nav-link mr-1 {{$category->slug ==="koskoss" ? "active":""}}"
                    ...
                    <div class="tab-content" id="pills-tabcontent">
                        @foreach($categories as $category)
                          <div class="tab-pane fade {{$category->slug ==="koskoss" ? "show active":""}}" id="{{$category->slug}}"
                            role="tabpanel"
